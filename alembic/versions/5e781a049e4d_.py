...
def upgrade() -> None:
    ...
    sa.Column('provider_model_id', sa.Integer(), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['parent_id'], ['chat_messages.message_id'], ),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('joined_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['chat_id'], ['project_chats.chat_id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ),
    sa.PrimaryKeyConstraint('chat_id', 'user_id')
    )
    op.create_table('project_chat_messages',
    sa.Column('message_id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('chat_id', sa.Integer(), nullable=False),
    sa.Column('parent_id', sa.Integer(), nullable=True),
    sa.Column('path', sqlalchemy_utils.types.ltree.LtreeType(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['author_id'], ['users.user_id'], ),
    sa.ForeignKeyConstraint(['chat_id'], ['project_chats.chat_id'], ),
    sa.ForeignKeyConstraint(['parent_id'], ['project_chat_messages.message_id'], ),
    sa.PrimaryKeyConstraint('message_id')
    )
